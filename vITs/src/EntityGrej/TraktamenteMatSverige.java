...
public class TraktamenteMatSverige implements Serializable {
    ...
    public TraktamenteMatSverige() {
    }

    public TraktamenteMatSverige(String typ) {
        this.typ = typ;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TraktamenteMatSverige)) {
            return false;
        }
        TraktamenteMatSverige other = (TraktamenteMatSverige) object;
